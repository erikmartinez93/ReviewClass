...
public class VariablesDemo1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * if we want to store whole numbers we can use below data types numbers without decimal parts
		 * like 10,23,4000,100000 etc but we can't use them to store decimal numbers
		 * like 12.3 1.5 100.4 etc
		 * byte
		 * short
		 * int 
		 * long
		 * although the above four data types can be used to store whole numbers we 
		 * will be using int most of the time as it can handle upto billions and does not 
